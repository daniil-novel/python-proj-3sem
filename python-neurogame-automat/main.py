...
def main():
    ...
    user_failed_image = pygame.transform.scale(user_failed_image, map_rendering.screen_size)
    ...
    while True:
        ...
        if map.check_level_exit(player):
            ...
            neural_network.save_weights("weights.txt")  # Сохранение весов модели в текстовый файл
            pygame.quit()
            return
